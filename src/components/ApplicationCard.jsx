import { Boxes, BoxesIcon, BriefcaseBusiness, Download, LucideBoxes, School, School2, School2Icon, SkullIcon } from "lucide-react"
    ...
    <Card className={'mb-6'}>
        ...
        <CardContent className={'flex flex-col gap-4 flex-1'}>
            <div className="flex flex-col md:flex-row justify-between">
                ...
                <div className="flex gap-2 items-center">
                <School2Icon size={15} />    {application?.education} 
                </div>
                <div className="flex gap-2 items-center">
                <LucideBoxes size={15} /> Skills:   {application?.skills} 
                </div>
            </div>
        </CardContent>
